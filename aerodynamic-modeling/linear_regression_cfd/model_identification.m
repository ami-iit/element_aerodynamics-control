...
A2=[data2(1);data2(6);data2(11);data2(16);data2(21)];%deg alpha
B2=3*90*ones(5,1); %deg beta
...
B3=[data3(1);data3(6);data3(11);data3(16);data3(21)];%deg beta 
ns3=size(B3,1);
...
B4=[data4(1);data4(6);data4(11);data4(16);data4(21)];%deg beta
ns4=size(B4,1);
...
XD_app_use=[(sin(A_r).^2).*(cos(B_r).^3)  cos(B_r).^3 cos(B_r).^2];% data for Regression Learner App
XD=[ones(ns,1) (sin(A_r).^2).*(cos(B_r).^3)  cos(B_r).^3 cos(B_r).^2];% data for linear regression through matlab script
c_dmodel=XD\Cd;% identified constant coefficients
