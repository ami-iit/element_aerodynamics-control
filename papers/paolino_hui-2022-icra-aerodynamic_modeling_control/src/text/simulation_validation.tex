...
\begin{figure}[t]
    \centering
        \subfigure{\label{fig:hovering_wind} \includegraphics[width=0.97\columnwidth]{./imagines/wind_hov.eps}}
        \subfigure{\label{fig:hovering_angMom}
        \includegraphics[width=0.97\columnwidth]{./imagines/angMom_hov.eps}}
        \subfigure{\label{fig:hovering_linMom}
        \includegraphics[width=0.97\columnwidth]{./imagines/linMom_hov.eps}}
        \subfigure{\label{fig:hovering_com}
        \includegraphics[width=0.97\columnwidth]{./imagines/posX_hov.eps}}        
...
\begin{figure}[t]
    \centering
        ...
        \includegraphics[width=0.97\columnwidth]{./imagines/wind_hspe.eps}}
        \subfigure{\label{fig:high_speed_angMom}
        \includegraphics[width=0.97\columnwidth]{./imagines/angMom_hspe.eps}}
        \subfigure{\label{fig:high_speed_linMom}
        \includegraphics[width=0.97\columnwidth]{./imagines/linMom_hspe.eps}}
        \subfigure{\label{fig:high_speed_com}
        \includegraphics[width=0.97\columnwidth]{./imagines/posY_hspe.eps}}        
