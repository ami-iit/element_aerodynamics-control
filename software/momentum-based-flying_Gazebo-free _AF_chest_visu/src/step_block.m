classdef step_block < matlab.System & matlab.system.mixin.Propagates
    ...
    methods (Access = protected)
        ...
        function [w_H_b, s, base_pose_dot, s_dot, jet_intensities, wrench_left_foot, wrench_right_foot,aerodynamics_forces,AoA,relative_velocity,v_wind] = stepImpl(obj, jets_input, torque)
            ...
            AoA=obj.aerodynamics.compute_AoA(w_kaxis_link,relative_velocity);% angle of attack
            ...
            v_wind=obj.aerodynamics_config.v_wind;
        ...
        function [out, out2, out3, out4, out5, out6, out7,out8,out9,out10,out11] = getOutputSizeImpl(~)
            ...
            out8 = [3 1]; % aerodynamics forces (x,y,z)
            out9 = [1 1]; % angle of attack AoA
            out10 = [3 1];%relative velocity
            out11 = [3 1]; % wind velocity
        end
