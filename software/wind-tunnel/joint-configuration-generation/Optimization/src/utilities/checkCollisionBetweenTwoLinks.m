function [c_coll_ij, grad_coll_ij, isColliding] = checkCollisionBetweenTwoLinks(w_H_i, w_H_j, centers_i, centers_j, b_centers_i, b_centers_j, radiuses_i, radiuses_j, J_i, J_j)
    ...
    for i = 1:size(centers_i, 1)
        ...
        for j = 1:size(centers_j, 1)
            ...
            grad_coll_ij = [grad_coll_ij; -computeSelfCollisionGradient(w_H_i, w_H_j, c_i, c_j, b_c_i, b_c_j, J_i, J_j)]; %#ok<AGROW> 
        end
    end
end