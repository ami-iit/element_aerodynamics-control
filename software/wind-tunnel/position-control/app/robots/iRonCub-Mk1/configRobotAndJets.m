...
torsoJointsLimit       = scaleTorsoJointsLimits * [-10, 60; -15, 15; -20, 20];
armsJointsLimit        = scaleArmsJointsLimits  * [-50, -5; 11, 50; 1, 50; 15, 90];
legsJointsLimit        = scaleLegsJointsLimits  * [-20, 40; 5, 30; 4, 9; -60, 0; -30, 15; -20, 20];
...
% Robot ports list
% Ports.BASE_STATE        = '/icubSim/floating_base/state:o'; % Gazebo plugin
% Ports.THROTTLE          = '/icub-jets/jets/input:i'; % Gazebo plugin
% Ports.JETS_THRUSTS      = '/icub-jets/jets/thrust:o'; % Gazebo plugin
