function [pos_vel_acc_jerk_CoM_des, rot_vel_acc_jerk_base_des] = ...
             computeReferencesBaseAndCoM(posCoM_init, w_R_b_init, moveFront, moveLateral, moveUpDown, rotateRoll, rotatePitch, ...
                                         rotateYaw, turbo_mode, goLandingPos, feetContactIsActive, oneFootIsInContact, t, Config)
    ...
    %
    persistent posCoM_0 rpyBase_0 posCoM_landing previous_feetInContact t_turbo
    ...
    rpyBase_ref(1:2)     = saturateInput(rpyBase_ref(1:2), Config.references.minBaseRP_flying, Config.references.maxBaseRP_flying);
    ...
    if feetContactIsActive || oneFootIsInContact
        ...
        rpyBase_ref(1:2) = saturateInput(rpyBase_ref(1:2), Config.references.minBaseRP_balancing, Config.references.maxBaseRP_balancing);
