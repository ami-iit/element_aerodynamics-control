function [H_angMomentum, g_angMomentum, ATilde_angular, BTilde_angular, deltaTilde_angular, verifyAngMomAndInertia, w_L_angMom_des] = ...
    ...
    BTilde_angular         = b_R_w * (Lambda_js(4:6,:) * Config.USE_JETS + Lambda_cs(4:6,:) .* feetContactIsActive);
    deltaTilde_angular     = b_R_w * ((Lambda_jb(4:6,:) * Config.USE_JETS + Lambda_cb(4:6,:) .* feetContactIsActive) * w_baseTwist - sigma) - b_LDDot_angMom_star;     
