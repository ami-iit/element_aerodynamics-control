function k = menu_customized(xHeader,varargin)
...
winTopGap   = 400;       % gap between top of screen and top of figure **
winLeftGap  = 900;       % gap between side of screen and side of figure **
