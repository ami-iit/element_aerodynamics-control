classdef step_block < matlab.System & matlab.system.mixin.Propagates
    ...
    methods (Access = protected)
        ...
        function [w_H_b, s, base_pose_dot, s_dot, jet_intensities, wrench_left_foot, wrench_right_foot, aerodynamic_forces, relative_velocity, alpha, beta, drag_force, normal_force] = stepImpl(obj, jets_input, torque, v_wind)
            ...
            [generalized_aerodynamics_wrench, aerodynamic_forces, relative_velocity, alpha, beta, drag_force, normal_force] = obj.compute_aero_wholebody(v_wind);
        ...
        function [generalized_aerodynamics_wrench, aerodynamic_forces, relative_velocity, alpha, beta, drag_force, normal_force] = compute_aero_wholebody(obj, v_wind)
