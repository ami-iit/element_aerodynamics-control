function [base_linear_velocity, omega_b, joints_velocity, dot_v_b, dot_omega_b, joint_acceleration, ...
          contact_detected, wrench_left_foot, wrench_right_foot] = ...
              forward_and_contact_dynamics(mass_matrix, bias_forces, joints_torque, generalized_ext_wrench, ...
                                           base_velocity, joints_velocity, JLeft_frameJac, JRight_frameJac, JDot_nu_LFOOT, ...
                                           JDot_nu_RFOOT, H_LFOOT, H_RFOOT, Config)
...
% [base_linear_velocity, omega_b , joints_velocity, contact_detected] = compute_velocity(mass_matrix, J_feet, base_velocity, joints_velocity, is_in_contact, Config);
