...
Config.gains.momentum.KD_angular =  125 .* ones(1,3) * 1.5; % 2*sqrt(Config.gains.momentum.KP_angular);
...
% WARNING! Equality constraint is activated with a separate joystick
