...
linkCdAs_predicted_train_plot = linkAeroForces_predicted_train.detach().numpy()[0,:]
...
# plt.scatter(linkAoAs_train_plot, linkCdAs_train_plot, s=128, label='CFD train dataset', facecolors='none', edgecolors='tab:blue', alpha=0.5, linewidths=3)
# plt.scatter(linkAoAs_val_plot, linkCdAs_val_plot, s=128, label='CFD validation dataset', facecolors='none', edgecolors='tab:orange', alpha=0.5, linewidths=3)
# plt.scatter(linkAoAs_train_plot, linkCdAs_predicted_train_plot, s=128, label='DNN train prediction', facecolors='none', edgecolors='tab:green', alpha=0.5, linewidths=3)
# plt.scatter(linkAoAs_val_plot, linkCdAs_predicted_val_plot, s=128, label='DNN validation prediction', facecolors='none', edgecolors='tab:red', alpha=0.5, linewidths=3)
plt.scatter(linkAoAs_train_plot, linkCdAs_predicted_train_plot-linkCdAs_train_plot, s=128, label='DNN train error', facecolors='none', edgecolors='tab:green', alpha=0.5, linewidths=3)
plt.scatter(linkAoAs_val_plot, linkCdAs_predicted_val_plot-linkCdAs_val_plot, s=128, label='DNN validation error', facecolors='none', edgecolors='tab:red', alpha=0.5, linewidths=3)
plt.xlabel(r'$\alpha_{link}$ [deg]')
plt.ylabel(r"$\Delta C_D A$")
# plt.ylim([-0.01, 0.01])
# plt.xlim([0, 10])
plt.grid()
...
plt.savefig(str(cwd/'head-NN-3.pdf'), format='pdf')
