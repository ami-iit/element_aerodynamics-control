...
aerodynamics_config.C_0(1:end)=1*ones(aerodynamics_config.NOL,1); % assume as constant value for all the links
aerodynamics_config.C_1(1:end)=1*ones(aerodynamics_config.NOL,1); % assume as constant value for all the links