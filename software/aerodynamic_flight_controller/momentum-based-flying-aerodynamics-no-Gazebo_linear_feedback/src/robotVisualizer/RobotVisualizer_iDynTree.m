classdef RobotVisualizer_iDynTree < matlab.System & matlab.system.mixin.CustomIcon
    ...
    methods (Access = protected)
        ...
        function stepImpl(obj, world_H_base, base_velocity, joints_positions, joints_velocity, jetIntensities,aerodynamics_forces_total)
            ...
            if obj.config.visualizeRobot
                ...
                if obj.viz.run()
                    ...
                    obj.updateAerodynamics_forces(aerodynamics_forces_total);
