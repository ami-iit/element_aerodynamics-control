...
testFrames = {'chest_r_jet_turbine', 'chest_l_jet_turbine'}; %% The frames to display


meshFilePrefix = [component_path '/models']; %% Path to the model meshes

modelPath = [component_path '/models/' robotName '/iRonCub/robots/' robotName '/'];  %% Path to the robot model

fileName='model_stl.urdf'; %% Name of the urdf file
