classdef RobotVisualizer < matlab.System & matlab.system.mixin.CustomIcon
    ...
    methods (Access = protected)
        ...
        function stepImpl(obj, world_H_base, base_velocity, joints_positions, joints_velocity, jetIntensities,aerodynamics_forces_single)
            ...
            if obj.config.visualizeRobot
                ...
                if obj.config.aerodynamics_forces
                    obj.updateAerodynamics_forces(aerodynamics_forces_single);
                end
        ...
        function updateAerodynamics_forces(obj,aerodynamics_forces_single)
...
%               Y0_update=0;
%               Z0_update=0;
              XA_update=aerodynamics_forces_single(1);
              YA_update=aerodynamics_forces_single(2);
              ZA_update=aerodynamics_forces_single(3);
