...
aerodynamics_config.C_D(1:end)=100*ones(aerodynamics_config.NOL,1); % assume as constant value 
aerodynamics_config.C_L(1:end)=0*ones(aerodynamics_config.NOL,1); % assume as constant value