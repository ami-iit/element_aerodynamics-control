...
% Config.initialConditions.base_position = [0;0;0.80];
Config.initialConditions.base_position = [0;0;100]; % test02 to let robot fall from high place
...
Config.initialConditions.joints = zeros(23,1);% zero position for dropping test
