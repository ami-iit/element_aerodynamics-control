...
% smoothing time for the CoM position reference
...
Config.weights.symArmsAndChestThrusts        = true;
Config.weights.symLeftAndRightThrusts        = false;
Config.weights.symAllThrusts                 = false;

% cost function weights
Config.weights.minArmsThrustDot              = 0.01;  % regularization
Config.weights.minChestThrustDot             = 0.01;  % regularization
Config.weights.minContactForcesDot           = 0.001; % regularization
Config.weights.minJointVel                   = 100;   % regularization
Config.weights.symmetryThrust                = 0.1;   % regularization
Config.weights.postural                      = 2.5;%2.5*100;
