classdef Aerodynamics_force_link < handle
    ...
    methods  
        ...
        function generalized_aerodynamics_wrench=compute_gener_af(obj,robot,aerodynamics_forces,frame)
            ...
            % frame which transfers aerodynamics forces from origin of
            % the frame to the base frame of robot
            ...
            %aerodynamics_wrench=[aerodynamics_forces;zeros(3,1)]; % aerodynamics moment effects are neglected 
...
%             
%             % calculate aerodynamics forces (R^3) vector acting on each single link expressed in world frame since all the
