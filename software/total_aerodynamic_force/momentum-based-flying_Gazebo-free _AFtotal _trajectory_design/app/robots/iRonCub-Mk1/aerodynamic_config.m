...
%                                                                         %
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
aerodynamics_config.v_wind=[0;3;0];%m/s  wind velocity
aerodynamics_config.rho=1.225; % kg/m^3 ,air density at 101.325kPa and 15 degree
aerodynamics_config.NOL=14; %number of links considered to be added aerodynamics forces + total aerodynamic force
% ['head'=1
...
aerodynamics_config.Ka(14)=1;% for total aerodynamic force
...
aerodynamics_config.C_2=zeros(aerodynamics_config.NOL,1);%lift coefficient
aerodynamics_config.C_3=zeros(aerodynamics_config.NOL,1);%lift coefficient

%cd=c0+c1*sin(a)^2*cos(beta)^2+c2*cos(beta)^2
aerodynamics_config.C_0(end)=0.1326; % 
aerodynamics_config.C_1(end)=0.0818; % 
aerodynamics_config.C_2(end)=0.0279;
aerodynamics_config.C_3(end)=0.0374;
